...
- `profileReleaseConsistency` compares planning version `v4.9.67` against latest GitHub release `v3.0.0`, records the missing `v4.9.67` tag ref, and surfaces 2 warning-only release/tag rows without failing `-Check`.
...
2. Add internal title/description metadata to generated profile SVG panels.
3. Refresh stale catalog field names in completed-work docs.
