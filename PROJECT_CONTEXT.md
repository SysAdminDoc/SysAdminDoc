...
- `linkValidationSummary` reports 185 URL targets checked with throttle 16 in 4404 ms and 0 warning host groups.
...
- Full live link validation has 0 fatal failures and 0 warnings in the latest v4.9.13 sync report.
