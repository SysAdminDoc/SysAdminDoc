...
1. Add generated artifact/render-budget reporting while the README remains the public routing surface.
2. Draft a PR-delivery transition checklist before any required-check enforcement is enabled.
3. Use the density-routing report to choose concrete Python rows for portfolio-only catalog review if artifact budgets stay healthy.
