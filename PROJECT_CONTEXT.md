...
- `projects.json` is the generated public project feed for portfolio consumption, including structured upstream attribution fields (`forkOf`, `forkOfUrl`, `upstreamLicense`), public-safe feed provenance, and redacted suppression records for rows omitted from the public catalog.
...
1. Add release/download trust metadata for executable assets.
