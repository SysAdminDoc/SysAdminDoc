...
1. Audit branch-protection/ruleset readiness again without enabling enforcement while direct pushes remain active.
2. Decide whether density-warning rows should move to portfolio-only browsing, using `readmeDensity` evidence.
3. Add generated artifact/render-budget reporting if the density review keeps the README as a public routing surface.
