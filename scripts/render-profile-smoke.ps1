...
(() => {
  ...
  const sections = ["Start Here", "Catalog Snapshot", "Featured Projects", "First-time setup", "PowerShell System Utilities", "Python Desktop Applications", "Browser Extensions & Userscripts"];
