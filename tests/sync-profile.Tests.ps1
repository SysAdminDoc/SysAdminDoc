...
Describe 'New-Readme generation (offline, fixture catalog)' {
    ...
    It 'renders a minimal text-only profile chrome without images or third-party render hosts' {
        ...
        $script:rendered | Should -Match 'I help small and midsize businesses put AI to work through tool rollout, workflow automation, team training, and ongoing support'
        $script:rendered | Should -Match '<a href="https://getparkerai\.com/"><b>Explore Parker AI services</b></a>'
        $script:rendered | Should -Match '<a href="https://sysadmindoc\.github\.io/ai/"><b>AI service overview</b></a>'
...
Describe 'Update-Header idempotency' {
    ...
    It 'produces a minimal text-only header with no image chrome' {
        ...
        $result | Should -Match 'Explore Parker AI services'
        $result | Should -Match 'AI service overview'
