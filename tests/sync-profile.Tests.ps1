...
Describe 'New-Readme generation (offline, fixture catalog)' {
    ...
    It 'renders a minimal text-only profile chrome without images or third-party render hosts' {
        ...
        $script:rendered | Should -Match 'AI implementation contractor with a 15-year enterprise IT and healthcare systems background'
        $script:rendered | Should -Match '<a href="https://sysadmindoc\.github\.io/ai/"><b>Explore AI implementation services</b></a>'
        $script:rendered | Should -Match '<a href="https://sysadmindoc\.github\.io/"><b>View my full portfolio'
